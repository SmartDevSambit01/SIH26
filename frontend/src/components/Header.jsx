...
export default function Header({ onNavigate, activeNav: propActiveNav = 'HOME' }) {
        ...
        <div className="ner-brand">
          <div className="ner-logo-icon">
            <svg viewBox="0 0 48 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <defs>
                <linearGradient id="greenGrad" x1="24" y1="10" x2="24" y2="32" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#00E599" />
                  <stop offset="1" stopColor="#0A7D4C" />
                </linearGradient>
                <linearGradient id="cyanGrad" x1="15" y1="16" x2="15" y2="32" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#2CD3B5" />
                  <stop offset="1" stopColor="#055B36" />
                </linearGradient>
                <linearGradient id="emeraldGrad" x1="33" y1="18" x2="33" y2="32" gradientUnits="userSpaceOnUse">
          ...
          <div className="ner-brand-text">
            <div className="ner-brand-title">NER Safe</div>
            <div className="ner-brand-tagline">Smarter Alerts. Safer Tomorrow.</div>
          </div>
        </div>
